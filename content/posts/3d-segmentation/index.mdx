...
During my time at D3S, I also worked on a 3D similarity model for CAD designs. Check it out [here](https://blog.accoumar.fr/building-a-3-d-similarity-model-for-cad-designs/).
