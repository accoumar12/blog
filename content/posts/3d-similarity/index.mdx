...
During my time at D3S, I also worked on a 3D part segmentation model for CAD designs. Check it out [here](https://blog.accoumar.fr/building-a-3-d-instance-segmentation-model-for-cad-designs/).
